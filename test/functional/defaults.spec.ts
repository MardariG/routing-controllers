...
describe("defaults", () => {
    ...
    it("should return undefinedResultCode from defaults config for void function", () => {
        assertRequest([3001], "get", "voidfunc", res => {
